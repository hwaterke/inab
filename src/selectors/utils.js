...
import {getPreviousMonthMoment, getSelectedMonthMoment, getNextMonthMoment} from './month';

type sumOfAmountsType = (items: {amount: number}[]) => number;
...
export const createInMonthSelectors = (itemSelector: any, itemMonthMapper: any) => ({
  previous: createInMonthSelector(itemSelector, itemMonthMapper, getPreviousMonthMoment),
  selected: createInMonthSelector(itemSelector, itemMonthMapper, getSelectedMonthMoment),
  next: createInMonthSelector(itemSelector, itemMonthMapper, getNextMonthMoment)
});

export const createUpToMonthSelectors = (itemSelector: any, itemMonthMapper: any) => ({
  previous: createUpToMonthSelector(itemSelector, itemMonthMapper, getPreviousMonthMoment),
  selected: createUpToMonthSelector(itemSelector, itemMonthMapper, getSelectedMonthMoment),
